      ...
      <div className="max-w-[1100px] mx-auto" data-testid="mybookings-root">
        <div className="flex items-end justify-between mb-8 gap-4 flex-wrap rise">
          <div>
            ...
            <h1
              className="font-display text-[34px] sm:text-[44px] lg:text-[54px] tracking-tighter font-medium leading-[0.95]"
              style={{ color: "var(--fg)" }}
            >
              My bookings
            </h1>
            ...
            >
              Edit, cancel, or revisit anything you've booked.
            </p>
          </div>
        ...
        <Tabs value={tab} onValueChange={setTab}>
          ...
          >
            {[
              {
                v: "upcoming",
                l: `Upcoming · ${groups.upcoming.length}`,
                tid: "tab-upcoming",
              },
              {
                v: "past",
                l: `History · ${groups.past.length}`,
                tid: "tab-history",
              },
            ].map((t) => (
              <TabsTrigger
          ...
          <TabsContent value="upcoming" className="mt-0">
            {loading ? (
              ...
              <BookingList
                ...
                emptyText="No upcoming bookings. Plan something."
                onEdit={(b) => {
                  setEditing(b);
                  setDialogOpen(true);
                }}
      ...
      {items.map((b, i) => (
        ...
        >
          <div className="flex-1 min-w-0">
            ...
            <div
              className="text-[11px] flex flex-wrap items-center gap-x-3 gap-y-1 mt-1"
              style={{ color: "var(--fg-soft)" }}
            >
              <span className="flex items-center gap-1">
                <Clock3 className="w-3 h-3" />
                {formatRange(b.start_time, b.end_time)} ·{" "}
                {durationMinutes(b.start_time, b.end_time)}m
              </span>
                ...
                <AlertDialogTrigger asChild>
                  <Button
                    ...
                    style={{
                      ...
                      border: "1px solid var(--status-maintenance-bd)",
                ...
                >
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription
                      style={{ color: "var(--fg-muted)" }}
                    >
                      "{b.title}" will be removed from the schedule.
                  ...
                  <AlertDialogFooter>
                    <AlertDialogCancel
                      ...
                      data-testid={`cancel-cancel-${b.id}`}
                    >
                      Keep booking
                    </AlertDialogCancel>
                    ...
                    <AlertDialogAction
                      ...
                      style={{
                        background: "var(--status-maintenance-fg)",
                        color: "white",
                      }}
                    >
                      Cancel booking
